...
export const IMAGE_ASSETS: ImageAssetEntry[] = [
  // ── ブランド ──────────────────────────────────────────
  {
    ...
    note: "HAMADORI CIRCLE PROJECT のものへ仮差し替え済み。浜通りクエストとして正式版を作るかはMTG判断。",
  },
  {
    ...
    group: "brand",
    status: "undecided",
    usedIn: ["ヘッダー", "ログイン", "新規登録", "パスワード再設定"],
    note: "仮差し替え済み。濃色の上に置くため白抜きが要る。",
  },
  {
  ...
  // ── トップページ ──────────────────────────────────────
  {
    ...
    note: "青緑 #30bca7 が72箇所に焼き込まれている。CSS変数では変えられない。浜通りの風景にするならイラストごと作り直し。",
  },
  {
    ...
    group: "top",
    status: "recolor",
    usedIn: ["トップページ（未ログイン）の下部", "フッター上部"],
    note: "#30bca7 / #0f8472 / #bcecd3 が焼き込まれている。",
  },
