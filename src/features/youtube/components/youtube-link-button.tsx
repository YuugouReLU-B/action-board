  ...
  return (
    ...
    >
      <path
        ...
        fill="var(--app-vendor-google-blue)"
      />
      <path
        d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
        fill="var(--app-vendor-google-green)"
      />
      <path
        d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
        fill="var(--app-vendor-google-yellow)"
      />
      <path
        d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
        fill="var(--app-vendor-google-red)"
      />
    </svg>
  );
}
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        onClick={handleLink}
        disabled={isLoading}
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-[var(--app-vendor-google-border)] rounded-md hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        style={{ fontFamily: "Roboto, sans-serif" }}
      >
        {isLoading ? (
          <span className="text-[var(--app-vendor-google-text)] text-sm font-medium">
            処理中...
          </span>
        ) : (
          <>
            <GoogleIcon className="w-5 h-5 flex-shrink-0" />
            <span className="text-[var(--app-vendor-google-text)] text-sm font-bold">
              Googleアカウントで連携
            </span>
          </>
        )}
