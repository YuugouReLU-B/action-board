...
const SP =
  "/private/tmp/claude-501/-Users-yuugou-dev-relu-action-board/7aa69d47-a729-42fa-9bd5-9cf298df78c5/scratchpad";
...
const targets = [
  ...
  [
    "ogp_mission_complete_base",
    "public/img/ogp_mission_complete_base.png",
    720,
  ],
  ...
  [
    "icon_add_line_friend",
    "public/img/mission-icons/actionboard_icon_work_20250713_ol_add-line-friend.svg",
    200,
  ],
  [
    "icon_join_event",
    "public/img/mission-icons/actionboard_icon_work_20250713_ol_join-event.svg",
    200,
  ],
  [
    "icon_instagram",
    "public/img/mission-icons/actionboard_icon_work_20250713_ol_instagram-like.svg",
    200,
  ],
  [
    "icon_x_post",
    "public/img/mission-icons/actionboard_icon_work_20250713_ol_x-post.svg",
    200,
  ],
  [
    "icon_referral",
    "public/img/mission-icons/actionboard_icon_work_20250713_ol_referral.svg",
    200,
  ],
...
for (const [name, rel, width] of targets) {
  ...
  await page
    ...
    .catch(() => console.log(`  ${name}: 読み込み待ちタイムアウト`));
